...
## Step 1: Deploy via BattleChainDeployer

All contracts that want attack mode must be deployed through `BattleChainDeployer`. This registers them with the `AttackRegistry`.
